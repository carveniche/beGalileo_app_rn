...
export default function reducer(state=initialState,action){
    ...
    switch(action.type){
        ...
        case REGISTER_BOOK_DEMO :{
            return{
                ...state,loading : true,register_book_demo_status : false,register_book_demo_response : action.payload.data
            }
        }
        case REGISTER_BOOK_DEMO_SUCCESS :{
            return{
                ...state,loading : false,register_book_demo_status : action.payload.data.status,register_book_demo_response : action.payload.data
            }
        }
