...
const MoreHelpScreen = (props) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ marginTop : 20,marginStart : 20 }}>
            <TouchableOpacity onPress={this.onEmailSupport} style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: normalize(19), paddingBottom: normalize(19) }}>
                ...
                <TouchableOpacity onPress={this.onChatSupport} style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: normalize(19), paddingBottom: normalize(19) }}>
                    <View style={{ flexDirection: 'row' }}>
                        <Image style={{ height: normalize(16), width: normalize(16), resizeMode: "stretch" }} source={ICON_MESSAGE} />
                ...
                <TouchableOpacity onPress={this.onCallSupport} style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: normalize(19), paddingBottom: normalize(19) }}>
                    <View style={{ flexDirection: 'row' }}>
